...
const signupUser = async (req, res) =>{
   ...
   // Access uploaded file from req.file
    ...
    try {
        const user = await User.signup(username, email, password, userType, secretKey);
...
module.exports = {signupUser, loginUser, loginCollege, getUsers, getUser, updateProfile, registerUser}