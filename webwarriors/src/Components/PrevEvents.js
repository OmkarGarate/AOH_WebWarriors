  ...
  return (
    <>
      ...
      <div className="elCat">
          ...
          <div className="categoryMain">
            ...
            <div className={`category ${isCategoryVisible ? 'visible' : 'hidden'}`}>
              ...
              <div className="cateBtn">
                <button style={{ backgroundColor: selectedCategory === 'Placements' ? 'red' : '' }} onClick={() => handleCategoryClick('Placements')}>Placements</button>
              </div>
              <div className="cateBtn">
      ...
      {groupedEvents.length === 0 && (
        <h2 className="tanse">There are no previous events</h2>
      )}
